...
url: "https://docs.github.com/en/actions/how-tos/manage-workflow-runs/manage-caches"
source: "https://github.com/github/docs/blob/27965d1687907bf5f365166999eea249ac88c088/content/actions/how-tos/manage-workflow-runs/manage-caches.md"
---
This article describes managing caches with the GitHub web interface, but you can also manage them:

* Using the REST API. See [https://docs.github.com/en/rest/actions/cache](https://docs.github.com/en/rest/actions/cache).
...
1. In the left sidebar, under the "Management" section, click **Caches**.
...
Alternatively, you can use the API to automatically list or delete all caches on your own cadence. For more information, see [https://docs.github.com/en/rest/actions/cache#about-the-cache-in-github-actions](https://docs.github.com/en/rest/actions/cache#about-the-cache-in-github-actions).
