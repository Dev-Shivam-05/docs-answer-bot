...
source: "https://github.com/github/docs/blob/27965d1687907bf5f365166999eea249ac88c088/content/actions/get-started/continuous-integration.md"
---
...
In addition to helping you set up CI workflows for your project, you can use GitHub Actions to create workflows across the full software development life cycle. For example, you can use actions to deploy, package, or release your project. For more information, see [https://docs.github.com/en/actions/how-tos/write-workflows](https://docs.github.com/en/actions/how-tos/write-workflows).

For a definition of common terms, see [Understanding GitHub Actions](https://docs.github.com/en/actions/get-started/understand-github-actions).

## Next steps

GitHub offers CI workflow templates for a variety of languages and frameworks. For tutorials on setting up continuous integration with these templates, see [https://docs.github.com/en/actions/tutorials/build-and-test-code](https://docs.github.com/en/actions/tutorials/build-and-test-code).
