...
source: "https://github.com/github/docs/blob/27965d1687907bf5f365166999eea249ac88c088/content/actions/reference/security/secrets.md"
---
## Naming your secrets
...
Secrets are limited to 48 KB in size. To store larger secrets, see [Using secrets in GitHub Actions](https://docs.github.com/en/actions/how-tos/write-workflows/choose-what-workflows-do/use-secrets#storing-large-secrets).
...
For security best practices using secrets, see [https://docs.github.com/en/actions/reference/security/secure-use#use-secrets-for-sensitive-information](https://docs.github.com/en/actions/reference/security/secure-use#use-secrets-for-sensitive-information).
