...
source: "https://github.com/github/docs/blob/27965d1687907bf5f365166999eea249ac88c088/content/actions/reference/workflows-and-actions/events-that-trigger-workflows.md"
---
...
Some events have multiple activity types. For these events, you can specify which activity types will trigger a workflow run. For more information about what each activity type means, see [https://docs.github.com/en/webhooks/webhook-events-and-payloads](https://docs.github.com/en/webhooks/webhook-events-and-payloads).

> [!NOTE]
> Not all webhook events trigger workflows.

Like GitHub Actions workflows, agentic workflows can be triggered by repository events and schedules. For an example, see [https://docs.github.com/en/copilot/how-tos/github-agentic-workflows/creating-github-agentic-workflows](https://docs.github.com/en/copilot/how-tos/github-agentic-workflows/creating-github-agentic-workflows).
...
Runs your workflow when activity related to a check run occurs. A check run is an individual test that is part of a check suite. For information, see [https://docs.github.com/en/rest/guides/using-the-rest-api-to-interact-with-checks](https://docs.github.com/en/rest/guides/using-the-rest-api-to-interact-with-checks). For information about the check run APIs, see [https://docs.github.com/en/graphql/reference/checks#object-checkrun](https://docs.github.com/en/graphql/reference/checks#object-checkrun) in the GraphQL API documentation or [https://docs.github.com/en/rest/checks/runs](https://docs.github.com/en/rest/checks/runs).
...
Runs your workflow when check suite activity occurs. A check suite is a collection of the check runs created for a specific commit. Check suites summarize the status and conclusion of the check runs that are in the suite. For information, see [https://docs.github.com/en/rest/guides/using-the-rest-api-to-interact-with-checks](https://docs.github.com/en/rest/guides/using-the-rest-api-to-interact-with-checks). For information about the check suite APIs, see [https://docs.github.com/en/graphql/reference/checks#object-checksuite](https://docs.github.com/en/graphql/reference/checks#object-checksuite) in the GraphQL API documentation or [https://docs.github.com/en/rest/checks/suites](https://docs.github.com/en/rest/checks/suites).
...
Runs your workflow when someone creates a Git reference (Git branch or tag) in the workflow's repository. For information about the APIs to create a Git reference, see [https://docs.github.com/en/graphql/reference/git#mutation-createref](https://docs.github.com/en/graphql/reference/git#mutation-createref) in the GraphQL API documentation or [https://docs.github.com/en/rest/git/refs#create-a-reference](https://docs.github.com/en/rest/git/refs#create-a-reference).
...
Runs your workflow when someone deletes a Git reference (Git branch or tag) in the workflow's repository. For information about the APIs to delete a Git reference, see [https://docs.github.com/en/graphql/reference/git#mutation-deleteref](https://docs.github.com/en/graphql/reference/git#mutation-deleteref) in the GraphQL API documentation or [https://docs.github.com/en/rest/git/refs#delete-a-reference](https://docs.github.com/en/rest/git/refs#delete-a-reference).
...
| Webhook event payload | Activity types | `GITHUB_SHA` | `GITHUB_REF` |
| --------------------- | -------------- | ------------ | -------------|
| [`discussion_comment`](https://docs.github.com/en/webhooks/webhook-events-and-payloads#discussion_comment) | - `created`<br/>- `edited`<br/>- `deleted`<br/> | Last commit on default branch | Default branch |

> [!NOTE]
> * More than one activity type triggers this event. For information about each activity type, see [https://docs.github.com/en/webhooks/webhook-events-and-payloads#discussion_comment](https://docs.github.com/en/webhooks/webhook-events-and-payloads#discussion_comment). By default, all activity types trigger workflows that run on this event. You can limit your workflow runs to specific activity types using the `types` keyword. For more information, see [Workflow syntax for GitHub Actions](https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#onevent_nametypes).
> * This event will only trigger a workflow run if the workflow file exists on the default branch.
> * Webhook events for GitHub Discussions are currently in public preview and subject to change.

Runs your workflow when a comment on a discussion in the workflow's repository is created or modified. For activity related to a discussion as opposed to comments on the discussion, use the [`discussion`](#discussion) event. For more information about discussions, see [https://docs.github.com/en/discussions/collaborating-with-your-community-using-discussions/about-discussions](https://docs.github.com/en/discussions/collaborating-with-your-community-using-discussions/about-discussions). For information about the GraphQL API, see [https://docs.github.com/en/graphql/reference/discussions#object-discussion](https://docs.github.com/en/graphql/reference/discussions#object-discussion).
...
Runs your workflow when someone forks a repository. For information about the REST API, see [https://docs.github.com/en/rest/repos/forks#create-a-fork](https://docs.github.com/en/rest/repos/forks#create-a-fork).
...
Runs your workflow when someone creates or updates a Wiki page. For more information, see [https://docs.github.com/en/communities/documenting-your-project-with-wikis/about-wikis](https://docs.github.com/en/communities/documenting-your-project-with-wikis/about-wikis).
...
| Webhook event payload | Activity types | `GITHUB_SHA` | `GITHUB_REF` |
| --------------------- | -------------- | ------------ | -------------|
| [`issue_comment`](https://docs.github.com/en/webhooks/webhook-events-and-payloads#issue_comment) | - `created`<br/>- `edited`<br/>- `deleted`<br/> | Last commit on default branch | Default branch |
...
Runs your workflow when an issue or pull request comment is created, edited, or deleted. For information about the issue comment APIs, see [https://docs.github.com/en/graphql/reference/issues#object-issuecomment](https://docs.github.com/en/graphql/reference/issues#object-issuecomment) in the GraphQL API documentation or [https://docs.github.com/en/webhooks/webhook-events-and-payloads#issue_comment](https://docs.github.com/en/webhooks/webhook-events-and-payloads#issue_comment) in the REST API documentation.
...
Runs your workflow when an issue in the workflow's repository is created or modified. For activity related to comments in an issue, use the [`issue_comment`](#issue_comment) event. For more information about issues, see [https://docs.github.com/en/issues/tracking-your-work-with-issues/learning-about-issues/about-issues](https://docs.github.com/en/issues/tracking-your-work-with-issues/learning-about-issues/about-issues). For information about the issue APIs, see [https://docs.github.com/en/graphql/reference/issues#object-issue](https://docs.github.com/en/graphql/reference/issues#object-issue) in the GraphQL API documentation or [https://docs.github.com/en/rest/issues](https://docs.github.com/en/rest/issues).
...
| Webhook event payload | Activity types | `GITHUB_SHA` | `GITHUB_REF` |
| --------------------- | -------------- | ------------ | -------------|
| [`label`](https://docs.github.com/en/webhooks/webhook-events-and-payloads#label) | - `created`<br/>- `edited`<br/>- `deleted`<br/> | Last commit on default branch | Default branch |

> [!NOTE]
> * More than one activity type triggers this event. For information about each activity type, see [https://docs.github.com/en/webhooks/webhook-events-and-payloads#label](https://docs.github.com/en/webhooks/webhook-events-and-payloads#label). By default, all activity types trigger workflows that run on this event. You can limit your workflow runs to specific activity types using the `types` keyword. For more information, see [Workflow syntax for GitHub Actions](https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#onevent_nametypes).
> * This event will only trigger a workflow run if the workflow file exists on the default branch.

Runs your workflow when a label in your workflow's repository is created or modified. For more information about labels, see [https://docs.github.com/en/issues/using-labels-and-milestones-to-track-work/managing-labels](https://docs.github.com/en/issues/using-labels-and-milestones-to-track-work/managing-labels). For information about the label APIs, see [https://docs.github.com/en/graphql/reference/issues#object-label](https://docs.github.com/en/graphql/reference/issues#object-label) in the GraphQL API documentation or [https://docs.github.com/en/rest/issues/labels](https://docs.github.com/en/rest/issues/labels).
...
Runs your workflow when a pull request is added to a merge queue, which adds the pull request to a merge group. For more information see [https://docs.github.com/en/pull-requests/how-tos/merge-and-close-pull-requests/merging-a-pull-request-with-a-merge-queue](https://docs.github.com/en/pull-requests/how-tos/merge-and-close-pull-requests/merging-a-pull-request-with-a-merge-queue).
...
| Webhook event payload | Activity types | `GITHUB_SHA` | `GITHUB_REF` |
| --------------------- | -------------- | ------------ | -------------|
| [`milestone`](https://docs.github.com/en/webhooks/webhook-events-and-payloads#milestone) | - `created`<br/>- `closed`<br/>- `opened`<br/>- `edited`<br/>- `deleted`<br/> | Last commit on default branch | Default branch |
...
Runs your workflow when a milestone in the workflow's repository is created or modified. For more information about milestones, see [https://docs.github.com/en/issues/using-labels-and-milestones-to-track-work/about-milestones](https://docs.github.com/en/issues/using-labels-and-milestones-to-track-work/about-milestones). For information about the milestone APIs, see [https://docs.github.com/en/graphql/reference/issues#object-milestone](https://docs.github.com/en/graphql/reference/issues#object-milestone) in the GraphQL API documentation or [https://docs.github.com/en/rest/issues/milestones](https://docs.github.com/en/rest/issues/milestones).
...
Runs your workflow when your workflow's repository changes from private to public. For information about the REST API, see [https://docs.github.com/en/rest/repos#edit](https://docs.github.com/en/rest/repos#edit).
...
Runs your workflow when activity on a pull request in the workflow's repository occurs. For example, if no activity types are specified, the workflow runs when a pull request is opened or reopened or when the head branch of the pull request is updated. For activity related to pull request reviews, pull request review comments, or pull request comments, use the [`pull_request_review`](#pull_request_review), [`pull_request_review_comment`](#pull_request_review_comment), or [`issue_comment`](#issue_comment) events instead. For information about the pull request APIs, see [https://docs.github.com/en/graphql/reference/pulls#object-pullrequest](https://docs.github.com/en/graphql/reference/pulls#object-pullrequest) in the GraphQL API documentation or [https://docs.github.com/en/rest/pulls](https://docs.github.com/en/rest/pulls).

Note that `GITHUB_SHA` for this event is the last merge commit of the pull request merge branch. If you want to get the commit ID for the last commit to the head branch of the pull request, use `github.event.pull_request.head.sha` instead. For more information about merge branches, see [https://docs.github.com/en/pull-requests/reference/pull-requests#pull-request-refs-and-merge-branches](https://docs.github.com/en/pull-requests/reference/pull-requests#pull-request-refs-and-merge-branches).
...
With the exception of `GITHUB_TOKEN`, secrets are not passed to the runner when a workflow is triggered from a forked repository. The `GITHUB_TOKEN` has read-only permissions in pull requests from forked repositories. For more information, see [https://docs.github.com/en/actions/tutorials/authenticate-with-github_token](https://docs.github.com/en/actions/tutorials/authenticate-with-github_token).
...
Runs your workflow when release activity in your repository occurs. For information about the release APIs, see [https://docs.github.com/en/graphql/reference/releases#object-release](https://docs.github.com/en/graphql/reference/releases#object-release) in the GraphQL API documentation or [https://docs.github.com/en/rest/releases](https://docs.github.com/en/rest/releases) in the REST API documentation.
...
| Webhook event payload | Activity types | `GITHUB_SHA` | `GITHUB_REF` |
| ------------------ | ------------ | ------------ | ------------------|
| [repository_dispatch](https://docs.github.com/en/webhooks/webhook-events-and-payloads#repository_dispatch) | Custom | Last commit on default branch | Default branch |

> [!NOTE]
> This event will only trigger a workflow run if the workflow file exists on the default branch.

You can use the GitHub API to trigger a webhook event called [`repository_dispatch`](https://docs.github.com/en/webhooks/webhook-events-and-payloads#repository_dispatch) when you want to trigger a workflow for activity that happens outside of GitHub. For more information, see [https://docs.github.com/en/rest/repos/repos#create-a-repository-dispatch-event](https://docs.github.com/en/rest/repos/repos#create-a-repository-dispatch-event).
...
> * In a public repository, scheduled workflows are automatically disabled when no repository activity has occurred in 60 days. For information on re-enabling a disabled workflow, see [https://docs.github.com/en/actions/how-tos/manage-workflow-runs/disable-and-enable-workflows#enabling-a-workflow](https://docs.github.com/en/actions/how-tos/manage-workflow-runs/disable-and-enable-workflows#enabling-a-workflow).
...
Runs your workflow when the status of a Git commit changes. For example, commits can be marked as `error`, `failure`, `pending`, or `success`. If you want to provide more details about the status change, you may want to use the [`check_run`](#check_run) event. For information about the commit status APIs, see [https://docs.github.com/en/graphql/reference/commits#object-status](https://docs.github.com/en/graphql/reference/commits#object-status) in the GraphQL API documentation or [https://docs.github.com/en/rest/commits#commit-statuses](https://docs.github.com/en/rest/commits#commit-statuses).
...
> [!NOTE]
> * More than one activity type triggers this event. Although only the `started` activity type is supported, specifying the activity type will keep your workflow specific if more activity types are added in the future. For information about each activity type, see [https://docs.github.com/en/webhooks/webhook-events-and-payloads#watch](https://docs.github.com/en/webhooks/webhook-events-and-payloads#watch). By default, all activity types trigger workflows that run on this event. You can limit your workflow runs to specific activity types using the `types` keyword. For more information, see [Workflow syntax for GitHub Actions](https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#onevent_nametypes).
> * This event will only trigger a workflow run if the workflow file exists on the default branch.

Runs your workflow when the workflow's repository is starred. For information about the pull request APIs, see [https://docs.github.com/en/graphql/reference/activity#mutation-addstar](https://docs.github.com/en/graphql/reference/activity#mutation-addstar) in the GraphQL API documentation or [https://docs.github.com/en/rest/activity/starring](https://docs.github.com/en/rest/activity/starring).
...
| Webhook event payload | Activity types | `GITHUB_SHA` | `GITHUB_REF` |
| ------------------ | ------------ | ------------ | ------------------|
| [workflow_dispatch](https://docs.github.com/en/webhooks/webhook-events-and-payloads#workflow_dispatch) | Not applicable | Last commit on the `GITHUB_REF` branch or tag | Branch or tag that received dispatch |
